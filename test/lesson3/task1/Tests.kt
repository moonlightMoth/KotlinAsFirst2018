...
class Tests {
    ...
    fun sin() {
        ...
        assertEquals(0.017452406459518247, sin(-18.832102629018816,1.0000022204460493e-10), 1e-15)
    }
    ...
    fun cos() {
        ...
        assertEquals(1.0, cos(-18.84955592153876,1e-100), 1e-12)
    }
    ...
    fun squareSequenceDigit() {
        ...
        assertEquals(8, squareSequenceDigit(38))
    }
